...
acc_key = "158S2pLhVB91x9fwxFB4822blgxToGXfgTn4sD0i"    
sec_key = "EfwwMw2q2xDlkYu2zruR9jgwMAbOgYMQAORBFNcD" 
upbit = pyupbit.Upbit(acc_key, sec_key)
start_cash = upbit.get_balance()
df = pyupbit.get_ohlcv("KRW-XRP", count=180) # 일봉 데이터
backtest = backTesting(df, start_cash)
backtest.execute()

print(backtest.execute)